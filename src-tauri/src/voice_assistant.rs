    ...
    if command_type != "none" {
        let _ = create_kaizen_task(
            ...
            &CreateKaizenTaskRequest {
                ...
                description: Some(format!("Voice/chat command processed. Type: {command_type}. Action: {action}")),
                priority: Some(3),
                source: Some("voice-assistant".to_string()),
                provider_id: Some("voice".to_string()),
                usage_log_id: Some(asst_msg_id.clone()),
        ...
        "todo" => {
            ...
            let _ = create_kaizen_task(
                ...
                &CreateKaizenTaskRequest {
                    ...
                    description: Some(format!("Task created via voice command: \"{input}\"")),
                    priority: Some(3),
                    source: Some("voice-command".to_string()),
                    provider_id: Some("voice".to_string()),
                    usage_log_id: Some(String::new()),
                    domain: Some("general".to_string()),
                    is_today: None,
                    is_minimum_version: None,
                    parent_id: None,
