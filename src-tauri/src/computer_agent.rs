...
pub fn start_agent_session(
    ...
    let _ = create_kaizen_task(
        ...
        &CreateKaizenTaskRequest {
            ...
            description: Some(format!("Computer agent '{}' started on {} with task: {}", req.name, req.target, req.task)),
            priority: Some(3),
            source: Some("computer-agent".to_string()),
            provider_id: Some("computer-agent".to_string()),
            usage_log_id: Some(id.clone()),
